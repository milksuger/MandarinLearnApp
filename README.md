...
- The curriculum navigator exposes four daily-life topics plus separate HSK 2.0 (six levels) and HSK 3.0 (three stages/nine levels) structures. Only the greeting topic has a published lesson; the other structures are empty slots. Official HSK word lists and syllabus text are not bundled until redistribution rights are confirmed. Writing attempts retain the source lesson placement and a derived outcome so authorized admins can inspect an individual learner's progress by path and unit.
