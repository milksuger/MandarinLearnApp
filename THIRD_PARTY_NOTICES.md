...
| `我` (`wǒ`) | Wei Gao and Vion Nicolas, [Wikimedia Commons file](https://commons.wikimedia.org/wiki/File:Zh-w%C7%92.ogg) | CC BY 2.0 fr | The Commons description identifies Mandarin 我 and a Beijing speaker. The original Ogg and served MP3 checksums are recorded in `content/audio-assets-manifest.json`. |
